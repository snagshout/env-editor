...
@section('content')
    <div class="row">
        <div class="col-12 mt-3 mb-5">
            <form method="post" action="{{ route('store_env_file', compact('bucket')) }}">
                @csrf
                    ...
                    <div class="col">
                        <div class="row ">
                            ...
                            <div class="col-2 bg-dark text-white p-3 text-right">
                                <a class="btn btn-success btn-sm " href="{{ route('list_env_files', compact('bucket')) }}"><i class="fas fa-step-backward"></i></a>
